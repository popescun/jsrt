...
var exports = {
  ...
  addonPath : 'libsciter_android_addon.so',
  ...
  setNativeActivity : function(activity) {
    this.binding.setNativeActivity(activity);
  },

  displayEngineReady : function() {
    return this.binding.displayEngineReady();
  },

  nativeWindowExist : function() {
    return this.binding.nativeWindowExist();
  },
...
var onincluded = function(binding) {
  console.log('sciter_android onincluded...');
